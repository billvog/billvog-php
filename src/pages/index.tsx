        ...
        <Scene duration="100%" triggerHook="onLeave" pin>
          {(progress) => {
            const normalizedProgress = Math.min(
              Math.floor((progress / 0.16 / 6) * 10),
              6
            );
            const blurStates = ["3xl", "2xl", "xl", "lg", "md", "sm"];
            return (
              <div
                className={`
                transition-all
                backdrop-filter backdrop-blur-${blurStates[normalizedProgress]} h-screen w-screen p-12 flex justify-center items-center
              `}
              >
                  ...
                  <div className="max-w-md text-white flex items-center flex-col rounded-3xl">
                    <div className="text-sm">
                      ...
                      <span>
                        ...
                        (Javascript, C++, C, Python, Java, etc.). Currently, I'm
                        kept busy by ReactJS and the project I'm developing
                        called Ferman (
                        <a
