...
const Index: React.FC<{}> = () => {
  return (
    ...
    >
      <div className="backdrop-filter backdrop-blur-3xl h-screen w-screen p-12 flex justify-center items-center">
        <div className="flex justify-center align-middle">
          <div className="p-6 bg-gray-700 text-white flex items-center flex-col rounded-3xl shadow-md">
            ...
            />
            <div className="mt-3 leading-tight">Βασίλης Βογιατζής</div>
        ...
        <div className="p-8 flex justify-center align-middle">
          <div className="max-w-md text-white flex items-center flex-col rounded-3xl">
            <div className="text-sm">
              ...
              <div className="my-2" />
              <span>
                I have been dealing with programming for a long time. I've
                learned several languages the last ⁓5 years (Javascript, C++, C,
                Python, Java, etc.). Currently, I'm kept busy by ReactJS and the
                project I'm developing called Ferman (
                <a
              ...
              <div className="my-2" />
              <span>
                I upload any new project of mine on Github. Find me there @{" "}
                <a
                  target="blank"
                  href="https://github.com/billvog"
